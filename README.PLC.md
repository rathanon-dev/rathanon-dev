...
My professional focus is centered on **Automation Host Development**, **PLC & Equipment Integration**, **Industrial Communication Protocols (TCP/IP, OPC, Modbus)**, and **MES/Data Pipeline Engineering** to streamline high-precision manufacturing operations.

---

## ⚙️ **Core Competencies**
- 🔧 **Automation & System Integration:** Developing robust Automation Host applications (.NET/C#) interfacing machine tools, PLCs, and factory Manufacturing Execution Systems (MES).
- 🌐 **Industrial Protocols & Networking:** Hands-on proficiency in TCP/IP Sockets, OPC UA/DA, Modbus RTU/TCP, Serial RS-232/485, and RESTful APIs.
- 💡 **Embedded Systems & Robotics:** Firmware programming on microcontrollers (ESP32, STM32, Arduino), multi-axis motion control, and circuit design.
- 🗄️ **Databases & DevOps:** Microsoft SQL Server, MySQL, advanced SQL queries, Git version control, Docker, WSL2, and Linux environments.

---

## 💻 **Technical Skills**
- **Programming Languages:** C#, C/C++, Python, SQL, JavaScript, TypeScript, PowerShell
- **Frameworks & Platforms:** .NET Framework (4.6/4.8), .NET 8, Windows Forms (WinForms), WPF, Windows Services & Background Daemons
- **Networking & Protocols:** TCP/IP Sockets, OPC UA/DA, Modbus, MQTT, RESTful APIs
- **Databases:** Microsoft SQL Server, MySQL, SQLite
- **Embedded & Hardware:** PLC Communication, ESP32, STM32, Sensor & Metrology Interfaces, Multi-Axis Mecanum Control
- **Tools & Systems:** Visual Studio, Git, Azure DevOps, Docker, WSL2, Hyper-V, Linux
...
## 📍 **Contact & Operational Availability**
- **Current Residence:** Rojana Road, Khan Ham, Uthai District, Phra Nakhon Si Ayutthaya 13000 *(Available to start immediately)*
